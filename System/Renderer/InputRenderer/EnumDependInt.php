...
class EnumDependInt extends AbstractInput implements InputInterface
{
    ...
    public function data(): array
    {
        ...
        list($targetObject, $targetField) = explode('|', $this->typeData['externo']);
        ...
        $out['selectType'] = 'enumdependint';
        $out['selectObjectTarget'] = $this->toCamelCase($targetObject, true);
        $out['selectKeyField'] = $targetField;
        $out['depend'] = $this->typeData['clave'];
